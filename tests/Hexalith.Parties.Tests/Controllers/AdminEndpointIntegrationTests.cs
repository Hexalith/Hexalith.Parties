...
public sealed class AdminEndpointIntegrationTests : IClassFixture<AdminEndpointIntegrationTests.AdminTestFactory>
{
    ...
    public async Task RebuildProjections_TenantsAdminDenied_ReturnsForbiddenAndDoesNotRebuildAsync()
    {
        _factory.TenantAccessService.Handler = (_, _, requirement, _) => Task.FromResult(
            requirement == Hexalith.Parties.Authorization.TenantAccessRequirement.Admin
                ? Hexalith.Parties.Authorization.TenantAccessDecision.Denied(
                    Hexalith.Parties.Authorization.TenantAccessDenialReason.InsufficientRole)
                : Hexalith.Parties.Authorization.TenantAccessDecision.Allowed);
    ...
    public sealed class AdminTestFactory : WebApplicationFactory<Program>
    {
        ...
        internal Hexalith.Parties.Tests.Authorization.TestTenantAccessService TenantAccessService { get; }
            = new();
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            builder.ConfigureTestServices(services =>
            {
                ...
                services.AddSingleton<Hexalith.Parties.Authorization.ITenantAccessService>(TenantAccessService);
            });
        }
    }
}
