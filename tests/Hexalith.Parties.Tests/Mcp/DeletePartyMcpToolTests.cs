...
public sealed class DeletePartyMcpToolTests
{
    ...
    public async Task DeletePartyAsync_InvalidPartyId_ThrowsValidationErrorAsync()
    {
        ...
        InvalidOperationException exception = await Should.ThrowAsync<InvalidOperationException>(
            () => DeletePartyMcpTool.DeletePartyAsync("not-a-guid", new ServiceCollection().AddSingleton<Hexalith.Parties.Authorization.ITenantAccessService, Hexalith.Parties.Tests.Authorization.TestTenantAccessService>().BuildServiceProvider()));
    ...
    {
        InvalidOperationException exception = await Should.ThrowAsync<InvalidOperationException>(
            () => DeletePartyMcpTool.DeletePartyAsync(Guid.NewGuid().ToString(), new ServiceCollection().AddSingleton<Hexalith.Parties.Authorization.ITenantAccessService, Hexalith.Parties.Tests.Authorization.TestTenantAccessService>().BuildServiceProvider()));
