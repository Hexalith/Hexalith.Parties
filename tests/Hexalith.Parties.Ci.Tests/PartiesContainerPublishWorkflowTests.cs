...
public sealed class PartiesContainerPublishWorkflowTests
{
    ...
    {
        string workflow = CiTestPaths.ReadRepoFile(".github/workflows/publish-parties-containers.yml");
    ...
    {
        string script = CiTestPaths.ReadRepoFile("scripts/publish-parties-containers.ps1");
