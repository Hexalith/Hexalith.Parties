...
public sealed class AppHostTenantsTopologyTests
{
    ...
    [Fact]
    public void AppHostProgramComposesTenantsWithStableResourceNameAndCommandApiDependency()
    {
    ...
    public void PartiesAspireExtensionAcceptsSharedDaprComponentsForTenantsComposition()
    {
        ...
        extension.ShouldContain("AddHexalithParties(commandApi, daprConfigPath, stateStore, pubSub)");
    }
