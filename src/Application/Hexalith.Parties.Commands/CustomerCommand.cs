...
public class CustomerCommand : CompanyEntityCommand
{
    ...
    /// <inheritdoc/>
    protected override string DefaultAggregateId() => PartiesDomainHelper.GetCustomerAggregateId(PartitionId, CompanyId, OriginId, Id);

    /// <inheritdoc/>
    protected override string DefaultAggregateName() => PartiesDomainHelper.CustomerAggregateName;
}