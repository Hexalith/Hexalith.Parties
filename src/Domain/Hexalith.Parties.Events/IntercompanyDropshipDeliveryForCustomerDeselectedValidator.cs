...
/// Implements the <see cref="AbstractValidator{IntercompanyDropshipDeliveryForCustomerDeselected}" />.
/// </summary>
/// <seealso cref="AbstractValidator{IntercompanyDropshipDeliveryForCustomerDeselected}" />
