...
/// Implements the <see cref="AbstractValidator{IntercompanyDropshipDeliveryForCustomerSelected}" />.
/// </summary>
/// <seealso cref="AbstractValidator{IntercompanyDropshipDeliveryForCustomerSelected}" />
