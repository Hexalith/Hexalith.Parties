...
> **Primary entry point for AI-assisted development and onboarding.** Regenerated by BMAD *Document Project* (**full rescan**, deep) on 2026-06-02 and reconciled for Epic 8 closure on 2026-08-18. Generated docs sit alongside the project's hand-maintained docs (linked below). When code and docs disagree, the code wins — file paths are cited throughout.
