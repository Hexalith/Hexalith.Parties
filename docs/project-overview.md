...
> Regenerated by BMAD *Document Project* (**full rescan**, deep, 2026-06-02) - updated after Epic 4 (`ConsumerPortal` profile) implementation on 2026-06-10.
...
- **Consumer portal** — FrontComposer-hosted `/me*` RCL for Consumer My Profile and Edit My Profile, using ConsumerPortal-owned ports adapted by the UI host to the fail-closed self-scoped accessor.
