...
- **NuGet** (key): Aspire/AppHost SDK 13.4.6, DAPR 1.18.5, FluentValidation 12.1.1, MediatR 14.2.0, FluentUI 5.0-rc.4-26180.1, ModelContextProtocol 2.2.0, `Hexalith.Memories.Client.Rest` 2.25.0. Full list with versions in [architecture.md §3](architecture.md).
