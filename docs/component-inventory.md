...
> Regenerated by BMAD *Document Project* (**full rescan**, deep, 2026-06-02) and reconciled for Epic 8 closure on 2026-08-18 (external-dependency versions refreshed 2026-09-05 for the Builds catalog adopt). Inventory of exactly 13 projects under `src` plus one sample project, 15 runnable .NET test projects plus one support host, Blazor UI components, and the retained DAPR actor.
...
- **NuGet** (key): Aspire/AppHost SDK 13.5.3, DAPR 1.18.5, FluentValidation 12.1.1, MediatR 14.2.0, FluentUI 5.0.0-rc.5-26219.1, ModelContextProtocol 2.2.0, `Hexalith.Memories.Client.Rest` 2.26.1. Full list with versions in [architecture.md §3](architecture.md).
