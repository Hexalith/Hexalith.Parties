...
- Repository pins win. Use SDK `10.0.302`, `net10.0`, C# 14, current Central Package Management, warnings-as-errors, and `-m:1`. Do not bundle framework, Aspire, MCP SDK, EventStore, or test-library upgrades into this cleanup.
