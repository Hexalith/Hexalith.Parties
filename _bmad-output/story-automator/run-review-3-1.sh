...
unset CLAUDECODE
claude --dangerously-skip-permissions 'Execute the story-automator review workflow for story 3.1.
...
Story file: _bmad-output/implementation-artifacts/3-1-publish-stable-contracts-package.md
Review implementation, find issues, fix them automatically. auto-fix all issues without prompting.

Do not review _bmad-output/implementation-artifacts/3-1-party-detail-projection-handler-and-actor.md; that is an older unrelated artifact.'
